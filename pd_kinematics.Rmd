...
datafolder <- paste0(dirname(dirname(rstudioapi::getSourceEditorContext()$path)), "/provevalentijn.github.io/data/") #set your working directory to the folder where you saved the datasets
tsfolder <- paste0(dirname(dirname(rstudioapi::getSourceEditorContext()$path)), "/provevalentijn.github.io/data/ts/") #folder with the timeseries output from OpenPose
```
